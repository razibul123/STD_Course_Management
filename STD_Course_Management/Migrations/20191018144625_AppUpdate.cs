    ...
    public partial class AppUpdate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseConfirm", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(nullable: true),
                    Blood_group = table.Column<string>(nullable: true),
                    Std_image = table.Column<byte[]>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CourseConfirm_Id = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SelectedCourse_CourseConfirm_CourseConfirm_Id",
                        column: x => x.CourseConfirm_Id,
                        principalTable: "CourseConfirm",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SelectedCourse_Course_Course_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SelectedCourse_CourseConfirm_Id",
                table: "SelectedCourse",
                column: "CourseConfirm_Id");

            migrationBuilder.CreateIndex(
                name: "IX_SelectedCourse_Course_Id",
                table: "SelectedCourse",
                column: "Course_Id");
        }
